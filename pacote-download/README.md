...
Nosso principal objetivo é demonstrar o consumo dos medicamentos controlados de uma farmácia. Utilizamos a linguagem SQL por meio do  `SGBD - postgresql` para a realização dos relatórios finais. Para uma demonstração mais visual utilizamos o `Power BI`. E utilizamos a linguagem `Python` para a criação da interface gráfica. Como principal resultado demonstramos tanto em quantidade quanto em real o valor do estoque total e o valor da perda por validade dos medicamentos existentes.
